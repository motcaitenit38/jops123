                            ...
                            <div class="brows-job-list">
                                <div class="col-md-1 col-sm-2 small-padding">
                                    <div class="brows-job-company-img">
                                        <img src="{{ asset($danhsach->logo) }}" class="img-responsive img-circle" alt=""/>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-5">
                                    <div class="brows-job-position">
                                        <h3><a href="{{ route('tuyendung.chitietquantam',$danhsach->id) }}"
                                               target="_blank" id="modelchitiet">{{ $danhsach->ten_doanh_nghiep }}</a>
                                        </h3>
                                        {{--<p>--}}
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="brows-job-location">
                                        ...
                                        {{--</p>--}}
                                        <p>
                                            <a href="{{ route('tuyendung.chitietquantam',$danhsach->id) }}"

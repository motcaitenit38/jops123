            ...
            <table border="0" width="600" cellpadding="0" cellspacing="0" class="container">
                <tr>
                    <td class="container-padding header" align="left">
                        Công việc của bạn có người quan tâm mới:
                    </td>
                </tr>
                <tr>
                    <td class="container-padding content" align="left">
                        ...
                        <div class="body-text">
                            Công việc <strong>{{ $job_name }} </strong> đã được công ty  quan tâm.
                            Bạn vui lòng truy cập website để xem thông tin công ty <strong>{{ $ten_cong_ty }}</strong>
                            <br><br>
                            Truy cập tại đây: <a href="{{ route('index.thongtincongty',[$thongtin_id_timviec,$id_tuyendung]) }}">Xem chi tiết công ty</a>
                            <br><br>

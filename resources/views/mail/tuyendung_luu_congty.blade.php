            ...
            <table border="0" width="600" cellpadding="0" cellspacing="0" class="container">
                <tr>
                    <td class="container-padding header" align="left">
                        Có công ty đã quan tâm hồ sơ của bạn:
                    </td>
                </tr>
                <tr>
                    <td class="container-padding content" align="left">
                        ...
                        <div class="body-text">
                            Công ty <strong>{{ $ten_cong_ty }} </strong> Đã quan tâm đến hồ sơ của bạn
                            <br><br>
                            Truy cập tại đây: <a href="{{ route('index.congtytuyendung', $id_employer) }}">Xem chi tiết công ty</a>
                            <br><br>

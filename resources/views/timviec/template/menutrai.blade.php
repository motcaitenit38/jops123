                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('post.index') }}"><i class="active-job fa fa-circle-o-notch" aria-hidden="true"></i>Công việc đang ứng tuyển</a>
                            </li>
                            <li>
                                <a href="{{ route('post.trangthai') }}"><i class="pending-job fa fa-circle-o-notch" aria-hidden="true"></i>Công việc đã Hoàn thành</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="javascript:void(0)"><i class="fa fa-clone" aria-hidden="true"></i>Quản lý hồ sơ <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('info-timviec.create') }}"><i class="active-job fa fa-circle-o-notch" aria-hidden="true"></i>Tạo mới hồ sơ</a>
                            </li>
                            <li>
                                <a href="{{ route('info-timviec.index') }}"><i class="pending-job fa fa-circle-o-notch" aria-hidden="true"></i>Danh sách hồ sơ</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('info-timviec.index') }}"><i class="fa fa-user-circle" aria-hidden="true"></i>My Profile</a>
                    </li>
                    <li>

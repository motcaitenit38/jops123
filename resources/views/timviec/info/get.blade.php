...
@section('content')
    <form id="post-form" class="form-group col-md-12" method="post" action="{{ route('info.store') }}"
        ...
        <div class="form-group row">
            <label for="loai_hinh_doanh_nghiep" class="col-sm-3 col-form-label">Tổng công suất</label>
            <div class="col-sm-8">
                {{ $info->tong_cong_suat }}
            </div>
        </div>
        <div class="form-group row">
            <label for="loai_hinh_doanh_nghiep" class="col-sm-3 col-form-label">Số lượng dây chuyền</label>
            <div class="col-sm-8">
                {{ $info->so_luong_day_chuyen }}
            </div>
        </div>
        <div class="form-group row">
            <label for="loai_hinh_doanh_nghiep" class="col-sm-3 col-form-label">Quy mô công ty</label>
            <div class="col-sm-8">
                {{ $info->dien_tich_quy_mo }}
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                <a href="{{ asset('timviec/thongtintimviec/'.$info->id.'/edit') }}" >

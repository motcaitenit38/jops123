...
@section('content')
    <form id="post-form" class="form-group col-md-12" method="post" action="{{ route('jop.store') }}"
          enctype="multipart/form-data" role="form">
        @csrf
        <div class="form-group row">
            <label for="jop_name" class="col-sm-3 col-form-label">Tên công việc</label>
            <div class="col-sm-8">
                <input name="jop_name" type="text" class="form-control" id="jop_name" placeholder="Tên công việc"
                       value="{{ old('jop_name') }}" required/>
            </div>
        </div>
        <div class="form-group row">
                ...
                <select name="salary_level" id="salary_level" class="form-control">
                    @foreach($salary_level as $salary_level)
                        <option value="{{ $salary_level->salary_level_id }}"
                                @if(old('salary_level') == $salary_level->salary_level_id) selected @endif>{{ $salary_level->salary_level_name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <textarea name="jop_detail" type="text" class="form-control" id="jop_detail"
                          placeholder="Chi tiết công việc" value="{{ old('jop_detail') }}" rows="6" required>
                </textarea>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <textarea name="jop_requirement" type="text" class="form-control" id="jop_requirement"
                          placeholder="Yêu cầu chi tiết" value="{{ old('jop_requirement') }}" rows="6" required>
                </textarea>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <textarea name="benefits" type="text" class="form-control" id="benefits"
                          placeholder="Phúc lợi khi làm việc" value="{{ old('benefits') }}" rows="6" required>
                </textarea>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input name="deadline" type="date" class="form-control" id="deadline" placeholder="Người liên hệ"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input name="contact" type="text" class="form-control" id="contact" placeholder="Người liên hệ"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input name="contact_email" type="text" class="form-control" id="contact_email"
                       placeholder="Người liên hệ" value="{{ old('contact_email') }}" required/>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input name="contact_phone" type="text" class="form-control" id="contact_phone"
                       placeholder="Người liên hệ" value="{{ old('contact_phone') }}" required/>
            </div>
        </div>
        <div class="form-group row">

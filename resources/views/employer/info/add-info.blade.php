...
@section('content')
    ...
    <form id="post-form" class="form-group col-md-12" method="post" action="{{ route('info.store') }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input name="company_name" type="text" class="form-control" id="company_name" placeholder="Tên công ty"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input name="logo" type="file" class="form-control" id="logo" placeholder="Logo công ty"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input name="cover" type="file" class="form-control" id="cover" placeholder="cover công ty"

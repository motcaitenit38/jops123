                            ...
                            <div class="brows-job-list">
                                <div class="col-md-1 col-sm-2 small-padding">
                                    <div class="brows-job-company-img">
                                        <img src="{{ asset($jop->employer_info->logo) }}" class="img-responsive" alt=""/>
                                    </div>
                                </div>
                                ...
                                {{--<div class="col-md-2 col-sm-2">--}}
                                    {{--<div class="job-action">--}}
                                        {{--<a class="edit" href="{{ asset('employer/jop/'.$jop->id.'/edit') }}"--}}
                                           {{--title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>--}}
                                        {{--<a class="delete" href="{{ asset('employer/jop/'.$jop->id.'/edit') }}"--}}
